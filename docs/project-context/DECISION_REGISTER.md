...
| D-063 | MPDSR programme and stage fields are discovered read-only from DHIS2 and presented as a short candidate list for owner confirmation; no MPDSR field is guessed. | Owner decision 2026-09-24; pending discovery |
