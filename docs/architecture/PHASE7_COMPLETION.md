...
- Alembic head `0005_phase567_ai_publishing` at the time of this report. **Superseded:** the current head is `0012_population_staging_identity` (see `docs/architecture/DATABASE.md`).
